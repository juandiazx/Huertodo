...
//TIENE QUE DEVOLVER UN ARRAY DE NOMBRES DE TODOS LOS HUERTOS

/*
 * cargarHuertosUsuario---> http:200, [huerto:JSON{id,nombre}]
 *
 * */
...
$sql = "SELECT `huertos`.`id`,`huertos`.`nombre` FROM `huertos`";

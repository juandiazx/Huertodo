...
$sql = "SELECT `solicitud`.`id`, `solicitud`.`nombreApellidos`, `solicitud`.`direccion`, `comunicacion_trabajadores`.`asunto`, `comunicacion_trabajadores`.`fecha`, `comunicacion_trabajadores`.`usuario_solicitud` FROM `solicitud`, `comunicacion_trabajadores` WHERE `comunicacion_trabajadores`.`usuario_solicitud` = `solicitud`.`id` AND `comunicacion_trabajadores`.`para` = 3";
